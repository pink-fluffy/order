...
var debug = require('debug')('order:server');
...
const apiRoot = process.env.ORDER_API_ROOT;
const app = express();
...
app.get('/', function (req, res, next) {
	res.send('Unicorn Store Order Microservice REST API');
});
...
var port = process.env.ORDER_PORT;
app.set('port', port);
